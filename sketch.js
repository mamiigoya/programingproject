...
var rain = [];
var rainingNow = true;
var colorbg = (100,100,100);

function setup() {
  createCanvas(600, 600); //create a 600px X 600px canvas
  for (i = 0; i < 100; i++) {
...
function draw() {
  background(colorbg); //an RGB color for the canvas' background
  flower();
  ground();
  ...
  //ellipse(width/2,height/2,20,20); // center of canvas, 20px
